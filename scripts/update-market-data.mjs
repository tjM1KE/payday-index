...
function buildBacktest(universe, series, failures) {
  ...
  return {
    ...
    methodology: {
      ...
      comparisons: "Compare the strategy with SPY, QQQ and VT using identical GBP 491.25 month-end contributions. A selected window starts two fresh paper pots, then applies the observed monthly returns and the same new deposit to both.",
